...
class SalesOrder(SellingController):
	...
	if TYPE_CHECKING:
		...
		naming_series: DF.Literal["B2B-.YYYY.-", "{order_number}"]
		net_total: DF.Currency
		order_branch: DF.Link
		order_note: DF.Text | None
		order_number: DF.Data
		order_origin: DF.Literal["Walkin", "Online", "B2B"]
